...
export default function Profile() {
  ...
  /* ============================================================
     Avatar Selection
     UI-only + localStorage persistence
     ============================================================ */

  const [selectedAvatar, setSelectedAvatar] = useState(() => {
    try {
      return localStorage.getItem("srip_profile_avatar") || null;
    } catch {
      return null;
    }
  });
  ...
  const handleAvatarChange = (avatarUrl) => {
    ...
    try {
      if (avatarUrl) {
        ...
        localStorage.removeItem("srip_profile_avatar");
      }
    } catch (error) {
      console.warn("Unable to save avatar preference.", error);
    }
    ...
    >
      ...
      <Box
        ...
        sx={{
          ...
          animation: prefersReducedMotion
            ? "none"
            : "profileFloatA 10s ease-in-out infinite",
      ...
      <Box
        ...
        sx={{
          ...
          animation: prefersReducedMotion
            ? "none"
            : "profileFloatB 12s ease-in-out infinite",
